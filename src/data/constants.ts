export const towns = [
  { name: 'Picayune', slug: 'picayune', businesses: 0 },
  { name: 'Poplarville', slug: 'poplarville', businesses: 0 },
  { name: 'Carriere', slug: 'carriere', businesses: 0 },
  { name: 'Nicholson', slug: 'nicholson', businesses: 0 },
  { name: 'McNeill', slug: 'mcneill', businesses: 0 },
